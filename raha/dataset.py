...
class Dataset:
    ...
    def __init__(self, dataset_dictionary):
        ...
        self.path = dataset_dictionary["path"] #dirty data path
    ...
    def get_evaluation(self, correction_dictionary):
        # dataframe_1 = self.dataframe
        # dataframe_2 = self.clean_dataframe
        # difference_dictionary = {}
        #
        # difference_dataframe = dataframe_1.where(dataframe_1.values != dataframe_2.values).notna()
        # for j in range(dataframe_1.shape[1]):
        ...
        for cell in correction_dictionary:
            if correction_dictionary[cell] == 1:
                output_size += 1
                if cell in actual_errors:
                    ed_tp += 1.0
            elif correction_dictionary[cell] == 0:
                output_size_0 += 1
        ...
        pre_1 = 0.0 if output_size == 0 else ed_tp/output_size
        pre_0 = 0.0 if output_size_0 == 0 else ed_tp_0/output_size_0

        p1_pre_1 = 0.0 if p1_output_size_1 == 0 else p1_ed_tp_1/p1_output_size_1
        p1_pre_0 = 0.0 if p1_output_size_0 == 0 else p1_ed_tp_0 / p1_output_size_0

        p2_pre_1 = 0.0 if p2_output_size_1 == 0 else p2_ed_tp_1 / p2_output_size_1
        p2_pre_0 = 0.0 if p2_output_size_0 == 0 else p2_ed_tp_0 / p2_output_size_0


        print("all")
        print("tp_1",ed_tp)
        print("de_1",output_size)
        print("tp_0",ed_tp_0)
        print("de_0",output_size_0)
        print("#############p1############")
        print("tp_1", p1_ed_tp_1)
        print("de_1",p1_output_size_1)
        print("tp_0",p1_ed_tp_0)
        print("de_0",p1_output_size_0)
        print("#############p2###########")
        print("tp_1",p2_ed_tp_1)
        print("de_1",p2_output_size_1)
        print("tp_0",p2_ed_tp_0)
        print("de_0",p2_output_size_0)
        return [pre_1, pre_0, p1_pre_1, p1_pre_0, p2_pre_1, p2_pre_0]
